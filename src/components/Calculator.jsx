                ...
                <div className="flex items-center jusify-center justify-center" style={{ fontFamily: '"Lato", sans-serif' }}>
                    <div className="flex md:flex-row flex-col items-center pt-6 px-4">
                        <div className="flex flex-col">
                            ...
                            <input value={fname} onChange={(e) => setfname(e.target.value)} id="fname" className="text-gray-600  focus:outline-none focus:border focus:border-pink-500 font-normal w-64 bg-white  h-10 flex items-center pl-3 text-sm border-gray-300  rounded border shadow" placeholder="Enter your name" />
                        </div>
                        ...
                        <div className="flex flex-col">
                            ...
                            <input id="lname" value={lname} onChange={(e) => setlname(e.target.value)} className="text-gray-700  focus:outline-none focus:border focus:border-pink-500 font-normal w-64 bg-white  h-10 flex items-center pl-3 text-sm border-gray-300  rounded border shadow" placeholder="Enter your beloved one's name" />
                        </div>
                    </div>
                </div>
